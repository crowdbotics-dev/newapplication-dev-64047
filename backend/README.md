...
## Project Structure
    ...
    ├── newapplication_dev_64047  # Django project configurations
...
1. Clone this repo and `cd newapplication_dev_64047`
...
2. Clone this repo and `cd newapplication_dev_64047`
